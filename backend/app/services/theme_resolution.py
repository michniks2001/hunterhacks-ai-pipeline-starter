...
def get_or_create_experience_dict(
    ...
    *,
    ...
    """
    Return (source, matched_slug, experience_dict, mode).
    ...
    if cached:
        return "cache", matched_slug, cached, mode
    ...
    experience = generate_neighborhood_experience(context)
    payload = experience.model_dump()
    save_experience_to_cache(storage_key, payload)
    return "llm", matched_slug, payload, mode
